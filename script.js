...
const MISSIONS = [
    ...
    },
    {
        level: 2,
        category: "🔑 키워드 조합",
        question: "세계에서 가장 작은 나라의 이름과 면적(km²)을 검색해 보세요. 나라 이름이나 면적 중 하나만 적어주세요!",
        hint: "💡 '세계에서 가장 작은 나라 면적'으로 검색해 보세요.",
        answers: ["바티칸", "바티칸 시국", "바티칸시국", "0.44"],
        acceptAny: true,
    ...
    },
    {
        level: 6,
        category: "➖ 마이너스(-) 활용",
        question: "'재규어'를 검색하면 자동차 브랜드가 많이 나옵니다. 동물 재규어의 최고 달리기 속도(시속)를 찾으려면 어떻게 검색해야 할까요? 검색어나 속도를 숫자만 적어보세요.",
        hint: "💡 '재규어 -자동차' 또는 '재규어 동물 -브랜드'처럼 불필요한 결과를 빼보세요.",
        answers: ["재규어 -자동차", "재규어 동물 -자동차", "재규어 -브랜드", "재규어 동물 -car", "80"],
        acceptAny: true,
    ...
    },
    {
        level: 9,
        category: "➖ 마이너스(-) 활용",
        question: "'수성'을 검색하면 경상북도 수성구 정보가 많이 나옵니다. 태양계 행성 수성의 공전 주기(태양을 한 바퀴 도는 데 걸리는 일수)를 찾아보세요. 단위 없이 숫자만 적어도 됩니다.",
    ...
    },
    {
        level: 11,
        category: "🔑 키워드 조합",
        question: "우리나라 최초의 인공위성 이름은 무엇이고, 몇 년도에 발사되었나요? 위성 이름이나 발사 연도(숫자만)를 적어주세요.",
        hint: "💡 '대한민국 최초 인공위성 발사'로 검색해 보세요.",
        answers: ["우리별 1호", "우리별1호", "우리별", "1992"],
        acceptAny: true,
    ...
    },
    {
        level: 13,
        category: "✨ 따옴표(\" \") 활용",
        question: "\"세계 문화유산\" \"제주도\"를 따옴표와 함께 검색해 보세요. 제주도가 유네스코 세계자연유산에 등재된 연도는? (단위 없이 숫자만)",
    ...
    },
    {
        level: 14,
        category: "➖ 마이너스(-) 활용",
        question: "'파이썬'을 검색하면 프로그래밍 언어 결과가 가득합니다. 뱀 파이썬의 최대 몸길이를 찾으려면 어떻게 검색할까요? 검색어나 길이(숫자)를 적어주세요.",
        hint: "💡 '파이썬 뱀 -프로그래밍' 또는 '파이썬 -코딩 -언어'로 검색해 보세요.",
        answers: ["파이썬 -프로그래밍", "파이썬 뱀 -프로그래밍", "파이썬 뱀 -코딩", "파이썬 -코딩", "10", "9", "10m", "9m"],
        acceptAny: true,
    ...
    },
    {
        level: 15,
        category: "🔑 키워드 조합",
        question: "세계에서 가장 깊은 호수의 이름과 최대 수심을 검색해 보세요. 호수 이름이나 수심(숫자만)을 적어주세요!",
        hint: "💡 '세계 가장 깊은 호수 최대 수심'으로 검색해 보세요.",
        answers: ["바이칼", "바이칼 호", "바이칼호", "1642", "1637", "1,642"],
        acceptAny: true,
    ...
    },
    {
        level: 16,
        category: "📑 탭 활용",
        question: "'첨성대 내부 구조'를 검색한 후 이미지 탭을 눌러보세요. 첨성대는 총 몇 단의 돌로 쌓여 있나요? (단위 없이 숫자만)",
